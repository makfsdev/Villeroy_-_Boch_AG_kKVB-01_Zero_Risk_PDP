...
(function (WATO) {
  ...
  const blueInfoBox = (classeContainer, classContent, img, title, lightText, boldText) => {
    return (
      ...
      classeContainer +
      "'> <div class=' " +
      (classContent ? classContent : "kk-blue-info-box-content") +
      "'> <img src=\"//localhost:9001/Villeroy_&_Boch_AG_kKVB-01_Zero_Risk_PDP/assets/" +
      img +
      '.png" alt=""> <p><b>' +
      title +
      "</b></br> " +
  ...
  const checkActiveUrl = (isUrl) => {
    if (isUrl) {
      ...
      if (blueBoxInfo && btnEditPayment) {
        WATO.event(WATO.qs(".checkout-stage-holder .js-edit-shipping-address"), "click", () => {
